...
def main():
    ...
    for fold in range(N_FOLDS):
        ...
        train_loader = DataLoader(
            ...
            shuffle=True,  # Simple shuffle — dataset is already balanced
        ...
        # NOTE: Class weights are NOT used in Focal Loss because the dataset is
        # pre-balanced offline via augmentation. All classes have equal representation.
        # Focal Loss gamma handles hard-example focusing without class weights.
